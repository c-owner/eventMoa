...
CREATE SEQUENCE BOARD_eventBoard_SEQ;
...
CREATE TABLE TABLE_BOARD_event(
	...
	BOARD_VIEW NUMBER(10) DEFAULT 0, -- 조회수
	BOARD_DATE DATE,
	CONSTRAINT eventBOARD_PK PRIMARY KEY(BOARDNUM),
	CONSTRAINT eventBOARD_FK FOREIGN KEY(BOARDID) REFERENCES TABLE_USER(MEMBERID)
);
