...
ALTER TABLE TABLE_BOARD_EVENT ADD EVT_START_DT DATE; -- 시작 날짜 
ALTER TABLE TABLE_BOARD_EVENT ADD EVT_END_DT DATE; -- 종료 날짜
ALTER TABLE TABLE_BOARD_EVENT DROP COLUMN ;


ALTER TABLE TABLE_BOARD_EVENT ADD BOARD_Zipcode varchar2(20);
ALTER TABLE TABLE_BOARD_EVENT ADD BOARD_Address varchar2(300);
ALTER TABLE TABLE_BOARD_EVENT ADD BOARD_Address_Detail varchar2(300);
ALTER TABLE TABLE_BOARD_EVENT ADD BOARD_Address_Etc varchar2(100);

-- select EVT_STRT_DT, count(EVT_STRT_DT) from table
-- where to_date(SYSDATE, 'yyyymmdd') < EVT_STRT_DT  and
-- to_date(SYSDATE , 'yyyymmdd') >= EVT_STRT_DT group by EVT_STRT_DT;
...
(BOARD_NUM, BOARD_TITLE, BOARD_CONTENT, BOARD_ID, BOARD_VIEW, BOARD_DATE, BOARD_LOCATION, EVT_START_DT, EVT_END_DT)
VALUES(BOARD_SEQ_EVENT.NEXTVAL, 'test1', 'test', 'admin1', 0, sysdate, 'test', sysdate, to_date('21-04-11 13:12:11', 'yy-mm-dd hh24:mi:ss'));

INSERT INTO TABLE_BOARD_EVENT
(BOARD_NUM, BOARD_TITLE, BOARD_CONTENT, 
BOARD_ID, BOARD_VIEW, BOARD_DATE, 
EVT_START_DT, EVT_END_DT, 
BOARD_ZIPCODE, BOARD_ADDRESS, BOARD_ADDRESS_DETAIL, BOARD_ADDRESS_ETC)
VALUES(BOARD_SEQ_EVENT.NEXTVAL, '호식이 두마리', '어서오세용 빨리오세용', 
'admin1', 0, sysdate, sysdate, to_date('21-04-11 13:12:11', 'yy-mm-dd hh24:mi:ss'),
'16577', '경기도 수원시', '세지로 23', '팔달구');
