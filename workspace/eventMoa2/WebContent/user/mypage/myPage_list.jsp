			...
			<div style="text-align: center;">
				...
				<div class="col-6 col-12-medium" style="margin: 0 0 -2em 0;">
        			<ul class="actions" style="display: inline-flex;">
						<li><a href="${pageContext.request.contextPath}/user/mypage/pointCharge.jsp" class="button" style="display: flex;">
						<img src="${pageContext.request.contextPath}/images/user/point.png" style="width: auto;">　포인트 충전소</a></li>
						<li><a href="${pageContext.request.contextPath}/user/mypage/pointReceipt.jsp" class="button" style="display: flex;">
        		...
        		<div class="col-6 col-12-medium" style="margin: 0 0 -2em 0;">
        			<ul class="actions" style="display: inline-flex;">
						<li><a href="${pageContext.request.contextPath}/user/mypage/myWrite.jsp" class="button" style="display: flex;">
						<img src="${pageContext.request.contextPath}/images/user/board.png" style="width: auto;">　내가 쓴 글　　</a></li>
						<li><a href="${pageContext.request.contextPath}/user/mypage/myReply.jsp" class="button" style="display: flex;">
				...
				<div class="col-6 col-12-medium" style="margin: 0 0 -2em 0;">
        			<ul class="actions" style="display: inline-flex;">
						<li><a href="${pageContext.request.contextPath}/user/mypage/myPage_password.jsp" class="button primary fit" style="display: flex;">
