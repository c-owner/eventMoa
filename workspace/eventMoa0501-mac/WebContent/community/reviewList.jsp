...
<jsp:include page="${pageContext.request.contextPath}/assets/public/sideBar.jsp"></jsp:include>
	...
	<p></p>
		...
		<section id="banner">
			<article class="column col4">
				...
				<p class="col_desc"> 인증후기에 글을 남기시려면 이벤트 게시글에서 리뷰 남기기를 통해 등록하실 수 있습니다.</p>
   ...
   -moz-text-align-last: center;">
               ...
               <c:when test="${list != null and fn:length(list) > 0}">
	               <c:forEach var="b_bean" items="${list}">
	               	<tr align="center" valign="middle" onmouseover="this.style.backgroudColor='F8F8F8'" onmouseout="this.style.backgroundColor='FFFFFF'">
	               		...
	               		<td style="font-family:Tahoma; font-size:10pt;">
	               			<div align="left">
	               				<a href="${pageContext.request.contextPath}/reviewboard/ReviewBoardView.rb?board_Num=${b_bean.getBoard_Num()}&page=${nowPage}">
	               					<c:set var = "board_title" value = "${b_bean.getBoard_Title()}"/>
	               		...
	               		<td>
	               			<div align="center">
		               			<c:set var = "user_id" value = "${b_bean.getBoard_Id()}"/>
	               		...
	               		<td>
	               			<div align="center">
	               				  <c:set var = "date1" value = "${b_bean.getBoard_Date()}"/>
         ...
         <div id="two" style="text-align: center; vertical-align: middle; ">
         			...
         			<br>
         			<!--  -->
               <%-- <a href="${pageContext.request.contextPath}/reviewboard/ReviewBoardWrite.rb"><div class="button primary small" style="float: right;">글쓰기✍</div></a> --%>								         
		</div>					
							</article>
						</section>
