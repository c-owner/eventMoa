...
<jsp:include page="${pageContext.request.contextPath}/assets/public/logo.jsp"></jsp:include>
	...
	<form action="${pageContext.request.contextPath}/search/" name="searchForm" id="search" method="post">
			...
			style="margin: 0 auto; width: 40%; border-radius: initial;">
				...
				<a href="${pageContext.request.contextPath}/searchViewPage.jsp" style="display: block;" class="button primary icon solid fa-search"
				style="border-radius: initial;"> Search</a>
				<a href="${pageContext.request.contextPath}/searchViewPage.jsp" style="display: none;" class="fas fa-search"></a>
			</div>
	</form>
	<br>
