							...
							<li class="liSection"> 
								...
								<div class="sc-div">
									<ul class="imgDiv2-ul" id="imgDiv2-ul">
										...
										<ul class="imgs_wrap">
											<span class="handle handleNext active" tabindex="0" role="button" aria-label="콘텐츠 더 보기"><b class="indicator-icon icon-rightCaret"></b></span>

											<span class="handle handlePrev active" tabindex="0" role="button" aria-label="이전 콘텐츠 보기"><b class="indicator-icon icon-leftCaret"></b></span>
										</ul>
			...
			function handleImgFileSelect(e){ 
				...
				filesArr.forEach(function(f){
					...
					reader.onload = function(e) {
						var html = "<div class=\"boxImg\"><a href=\"javascript:void(0);\" id=\"img_id_"+index+"\">"
