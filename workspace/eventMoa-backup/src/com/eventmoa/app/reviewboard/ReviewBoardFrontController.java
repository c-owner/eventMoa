...
public class ReviewBoardFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "/reviewboard/ReviewBoardWrite.rb":
			String e_board_Title = req.getParameter("e_board_Title");
			String e_board_Num = req.getParameter("e_board_Num");
			
			
			forward = new ActionForward();
			forward.setRedirect(false);
			req.setAttribute("e_board_Title", e_board_Title);
			req.setAttribute("e_board_Num", e_board_Num);
