				...
				<div class="signup_message" id="signup_message">
					<br>
						...
						<a href="${pageContext.request.contextPath}/user/mypage/UserModifyName.us" style="display: flex;">
							<div class="col-12" style="width: 35%; color: #202124;">아이디</div><div class="cate">${session_id}</div><span class="arrow" aria-hidden="true">></span>
						</a>
						...
						<a href="${pageContext.request.contextPath}/user/mypage/myPage_address.jsp" style="display: flex;">
							<div class="col-12" style="width: 35%; color: #202124;">주소</div><div class="cate">${user_Address}</div><span class="arrow" aria-hidden="true">></span>
						</a>
						<hr style="margin-inline: auto;">
