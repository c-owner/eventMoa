...
<html>
	...
	<c:set var="e_board_Title" value="${e_board_Title}"/>
	<c:set var="e_board_Num" value="${e_board_Num}"/>
				...
				<p class="col_desc"> </p>
					...
					<tr>
						...
						<td style="padding-left:10px;">
							${e_board_Num} 
							<input type="hidden" name="e_board_Num" value="${e_board_Num}">
						</td>
					</tr>
					<tr height="30px">
						<td align="center" style="width: 25%;">
						...
						<td style="padding-left:10px;">
							${e_board_Title} 
							<input type="hidden" name="e_board_Title" value="${e_board_Title}">
						</td>
					</tr>
					<tr height="30px">
						<td align="center" style="width: 25%;">
